...
PARAM$exp_input <- "HT6510_final02" #con 50 iteraciones y los landa para optimizar
...
PARAM$semillas <- c(700561, 333233, 911111, 311111, 301057, 104311, 103903, 102871, 104287, 103319)
