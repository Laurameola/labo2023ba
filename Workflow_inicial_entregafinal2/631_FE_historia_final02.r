...
PARAM <- list()
PARAM$experimento <- "FE6310_final02"

PARAM$exp_input <- "DR6210_final02" #con ranking zero fijo y nuevas variables
...
PARAM$RandomForest$semilla <- 700561 # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla <- 700561
