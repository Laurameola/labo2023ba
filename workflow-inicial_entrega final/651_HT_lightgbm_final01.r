...
PARAM <- list()
PARAM$experimento <- "HT6510_final01"

PARAM$exp_input <- "TS6410_final01"

# En caso que se haga cross validation, se usa esta cantidad de folds
PARAM$lgb_crossvalidation_folds <- 5

PARAM$lgb_semilla <- 700561# cambiar por su propia semilla
...
PARAM$lgb_basicos <- list(
  ...
  bagging_fraction = 0.8, # 0.0 < bagging_fraction <= 1.0 - Se modifica
...
PARAM$bo_iteraciones <- 100 # iteraciones de la Optimizacion Bayesiana - Se modifica a 100
